...
const experiences = [
    ...
    },
    {
        ...
        location: 'Remote',
        description: 'Learning Python fundamentals including data types, control flow, functions, OOP concepts, and file handling. Building small scripts and exploring libraries like Pandas, NumPy, and Matplotlib for data analysis.',
        highlights: [
            'Python fundamentals — variables, loops, functions, OOP',
            'Data analysis with Pandas and NumPy',
            'Scripting and automation for everyday tasks',
        ],
        tags: ['Python', 'Pandas', 'NumPy', 'Matplotlib', 'OOP'],
        color: '#8b5cf6',
    },
    {
        id: 3,
