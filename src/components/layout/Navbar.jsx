        ...
        >
            <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3.5">
                <div className="flex items-center justify-between gap-4">
                    {/* Brand Name */}
                    <a href="#home" className="text-base font-black tracking-tight transition hover:opacity-80" onClick={() => setActiveSection('home')}>
                        Jeevanantham
                    </a>
                        ...
                        {navLinks.map(([label, href]) => {
                            ...
                            return (
                                <a 
                                    ...
                                    className={`rounded-lg px-3 py-2 text-sm font-semibold transition ${linkClasses(id)}`}
                                >
                                    {label}
                                </a>
                            );
                                ...
                                {navLinks.map(([label, href]) => {
                                    ...
                                    return (
                                        <a 
                                            ...
                                            className={`rounded-lg px-3 py-2.5 text-sm font-semibold ${linkClasses(id)}`}
                                        >
                                            {label}
                                        </a>
                                    );
