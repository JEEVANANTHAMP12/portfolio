...
const ProjectCard = ({ project, index }: { project: any; index: number }) => {
    return (
        ...
        >
            <div className="relative h-full bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl rounded-2xl overflow-hidden border border-gray-400/40 hover:border-purple-400/50 transition-all duration-500 flex flex-col hover:shadow-2xl hover:shadow-purple-500/20">
                {/* Project Image */}
                ...
                <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex flex-wrap gap-2 mt-auto">
                        {project.tags.map((tag: string, idx: number) => (
                            <span 
                                key={idx}
                                className="px-3 py-1 text-xs bg-white/5 text-gray-300 rounded-full border border-gray-400/30"
                            >
                                {tag}
                            </span>
                        ))}
    ...
    return (
        <section id="projects" className="min-h-screen py-16 md:py-20 lg:py-24 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                ...
                >
                    <motion.span 
                        className="inline-block text-sm text-purple-400 uppercase tracking-widest mb-4 font-medium"
                ...
                >
                    <motion.a
                        ...
                        className="inline-flex items-center gap-2 px-8 py-4 bg-white/5 backdrop-blur-xl text-white rounded-full font-semibold border border-white/10 hover:border-white/30 hover:bg-white/10 transition-all"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                    >
